...
title: I Am Free to Dream — Kui adaptation brief
language: Kui
slug: kui
collection_order: 62
...
description: Kui lyrics, cultural references and musical direction.
tags:
- i-am-free-to-dream
- language-adaptation
sources:
...
script: Odia proposed; confirm Kui variety and orthography
status: draft
generated:
...
---
# I Am Free to Dream — Kui adaptation brief
...
**Script:** Odia proposed; confirm Kui variety and orthography  
**Musical direction:** Kui intimate narrative folk song with an unhurried communal response
...
Keep the act of making at the emotional centre: a person gathers, shapes and shares a world. Build the song with a Kui-speaking collaborator’s phrasing and musical knowledge rather than borrowing the Odia arrangement wholesale. The palette below is deliberately a provisional contemporary one.
...
Odisha’s Kandha handbook distinguishes Kui in Kandhamal from Kuvi in Koraput. This is a crucial linguistic distinction when selecting a collaborator and interpreting regional music references.

Language or community context: [SCSTRTI — Kandha handbook](https://tribal.nic.in/repository/ViewDoc.aspx?RepositoryNo=TRI28-08-2017121648&file=Docs%2FTRI28-08-2017121648.pdf).
...
Work from a Kui-specific lyric and local speech rhythm; let a gentle pulse emerge only after the words find their shape.

Warm lead, a quietly played community-appropriate drum and short flute replies. Begin without a fixed pulse; let one emerge through the reviewed wording. Use a small unison response only after the invitation, with instrument names and tuning settled locally.
...
The opening is solo and flexible. Gathering introduces motion; the potter statement interrupts it with a full breath. Let the final refrain become briefly shared and end with one unaccompanied line. Keep a distinct gathering breath and a fuller potter pause, with soft instruments sustaining underneath. Add warmth without accelerating or building a dramatic crescendo. End in peaceful, hopeful contentment.

## Style prompt

```text
Intimate Kui contemporary poetic folk song in the approved local variety, warm clear solo voice and natural Kui diction. Quiet local hand drum and short flute replies, a flexible opening with a gentle pulse emerging from the words. Small unison responses only on existing refrain lines near the end. Separate the gathering phrases and pause fully after the potter declaration, with a soft tone sustaining below. Give the mountain-and-cloud invitation a gentle lift, let the final dreams be sung together briefly, then end on one unaccompanied line. Work from a Kui-specific lyric and local speech rhythm; let a gentle pulse emerge only after the words find their shape. Warm youthful delivery; calm, soulful joy, affection and wonder. Keep the pace unhurried throughout; finish with peaceful hope. No mournful delivery, driving beat or dramatic crescendo.
```
...
2. Check that the local vocal cadence and melodic treatment are audible, and that the regional character comes through beyond instrument names. Work from a Kui-specific lyric and local speech rhythm; let a gentle pulse emerge only after the words find their shape.
...
Native title and adaptation pending. Confirm the Kui variety and working orthography with the adapter; Odia script is a proposed option, not a substitute for language review. Do not confuse Kui with Kuvi or assume an Odia-speaking singer will supply accurate Kui pronunciation. Community-specific musical form remains to be chosen.
