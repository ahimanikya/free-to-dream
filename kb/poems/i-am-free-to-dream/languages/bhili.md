...
title: I Am Free to Dream — Bhili — variety to be selected adaptation brief
language: Bhili — variety to be selected
slug: bhili
collection_order: 43
poem: i-am-free-to-dream
lyric_status: Adaptation pending
review_status: needs-native-review
description: Bhili — variety to be selected lyrics, cultural references and musical
  direction.
tags:
- i-am-free-to-dream
- language-adaptation
...
script: Specific language variety and working script to be agreed
status: draft
generated:
  by: process:collection-import
  at: '2026-09-23T02:00:25+00:00'
---
# I Am Free to Dream — Bhili — variety to be selected adaptation brief
...
**Script:** Specific language variety and working script to be agreed  
**Musical direction:** Bhili community-led lyrical folk song with an open refrain
...
Begin with a simple vocal shape that a collaborator can rebuild in their own variety. Gathering the world and inviting another person to join can move from solo voice to a restrained shared refrain without borrowing a festival text.

## Cultural grounding

IGNCA’s Bhil artists documentation includes Bhuri Bai speaking about Bhil song. It is a particular community reference; the broad Bhili label does not identify one uniform lyric or musical tradition. [IGNCA — Bhuri Bai on Bhil Song](https://ignca.gov.in/divisionss/janapada-sampada/tribal-art-culture/bhil-artists-of-madhya-pradesh-and-rajasthan/video-clip-bhuri-bai-on-bhil-song/)
...
Proposed palette: lead voice, one softly played local drum, a short flute reply and a small unison chorus. Let the collaborator choose instrument names, tuning and rhythmic pattern before treating these as community-specific.

## Emotional shape

Keep the opening and potter stanza solo. Introduce the chorus at the invitation using existing words, then let the final shared-dreams line return to one voice.
...
```text
Tender contemporary Bhili poetic folk song in the approved local variety. Warm clear solo storytelling voice, one quiet local hand drum, short flute replies and a small unison response on existing refrain words. Spacious complete phrases and a gentle pulse shaped by the language. Separate the repeated gathering phrases and pause fully after the potter declaration; sustain softly underneath. Keep early verses solo, introduce shared voices at the mountain invitation, and return to one tender voice for the final dream-weaving line. Intimate acoustic scale.
```
...
Native title, specific Bhili variety and script pending. Choose these with a community collaborator before translating; do not create a mixture of Bhili, Bhilali, Wagdi or other varieties under a generic label. The linked recording is a reference record, not an audio analysis.
