...
Confirm the optional bamboo-string colour locally and avoid adding a larger instrumental ensemble.
...
- [Government of Meghalaya — Garo festivals and instruments](https://megartsculture.gov.in/festivals-garo.html)
...
Optional sparse chigring-like plucks between phrases. Confirm the optional bamboo-string colour locally and avoid adding a larger instrumental ensemble.
...
```text
Garo indie-folk ballad with warm youthful male vocals, intimate soulful delivery, and clear natural Garo pronunciation. Quiet joy, affection, wonder, and peaceful contentment. Gentle, unhurried 6/8 sway with spacious phrasing. Earthy acoustic production: fingerpicked guitar, mellow bamboo flute, rounded acoustic bass, delicate hand percussion, and soft sustained strings. Optional sparse chigring-like plucks between phrases. Sparse voice-and-guitar opening; gradually add warmth and gently blooming refrain harmonies while maintaining the same relaxed pace. Leave a breath between repeated gathering phrases and a fuller pause after the potter declaration, with instruments sustaining underneath. End softly with warmth and hope. Restrained vocal ornamentation and gentle dynamics throughout.
```
