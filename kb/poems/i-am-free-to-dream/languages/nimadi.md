...
Start as a quiet personal statement, with warmth building through gathering and making. Hold the full potter pause, then gently lift the mountain invitation. Let the final dream-weaving refrain become shared before the lead finishes alone.
...
```text
Tender contemporary Nimadi storytelling folk song, warm lightly textured male lead and clear natural Nimadi diction. Speech-led verses, sparse plucked strings, a low acoustic sustain and quiet hand percussion. A simple returning refrain gathers the story. Separate the gathering phrases and pause fully after the potter declaration, letting a tone sustain below. Begin close and sparse, build warmth through making, lift the mountain-and-moon invitation, then let a second voice echo supplied final refrain words. End with the lead alone, affectionate and quietly hopeful.
```
