...
<section id="collection" class="featured-collection"><div class="featured-heading"><div class="section-heading"><div class="eyebrow">A FEW VOICES TO BEGIN WITH</div><h2>One poem. Many beginnings.</h2><p>Start with a song, return to the Odia original, or help bring a new voice into the collection.</p></div><a class="text-link" href="languages.html">All {len(languages)} languages →</a></div><p class="swipe-hint">Swipe to explore the featured languages →</p><div class="language-grid featured-grid" role="region" aria-label="Featured languages" tabindex="0">{featured}</div><a class="button secondary browse-all" href="languages.html">Browse the full collection →</a></section>
